public class FarbFernseherDemo {
    ...
    public static void main(String[] args) {
        ...
        if(ff1.istAngenehmerAls(ff2)) System.out.println("Farbfernseher 1 ist angenehmer als Farbfernseher 2");
        else if(ff2.istAngenehmerAls(ff1)) System.out.println("Farbfernseher 2 ist angenehmer als Farbfernseher 1");
        else System.out.println("Beide Farbfernseher sind komisch eingestellt");
        System.out.println();
        ...
        if(ff1.istAngenehmerAls(ff2)) System.out.println("Farbfernseher 1 ist angenehmer als Farbfernseher 2");
        else if(ff2.istAngenehmerAls(ff1)) System.out.println("Farbfernseher ist angenehmer als Farbfernseher 1");
        else System.out.println("Beide Farbfernseher sind komisch eingestellt");
        System.out.println();
    }
}
